...
<p className="text-sm text-gray-700 mb-2">AdminDashboard/tryCategory</p>
<h1 className="text-2xl font-semibold">Try Category</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:grid-cols-2">
                     ...
                     <Card x-chunk="dashboard-05-chunk-3" className={cn(' lg:rounded-2xl shadow-lg')}>
                        ...
                        <CardContent className="items-center space-y-6 grid" >                          
                              ...
                              <div className='space-y-2'>
                                <h3>Manage Front Borders:</h3>
                              <div className="flex flex-col lg:flex-row justify-center lg:space-x-4 space-y-4 lg:space-y-0">
                                
                                <div className=''>
                                <Label className='my-1'>Top :</Label>
                                <Input
                                  type="text"
                                  defaultValue={"23%"}
                                  onChange={(e) => {
                                ...
                                <div className='my-2'>
                                <Label className='my-1'>Bottom :</Label>
                                <Input
                                  type="text"
                                  defaultValue={"23%"}
                                  onChange={(e) => {
                                ...
                                <div className='my-2'>
                                <Label className='my-1'>Right :</Label>
                                <Input
                                  type="text"
                                  defaultValue={"23%"}
                                  onChange={(e) => {
                                ...
                                <div className='my-2'>
                                <Label className='my-1'>Left :</Label>
                                <Input
                                  type="text"
                                  defaultValue={"23%"}
                                  onChange={(e) => {
