...
const DiscountDeals = ({ initialProducts,totalCount,initialPage, limit, priceRanges, user , categories , collections }: ProductReelProps) => {
    ...
    <section className='py-4'>
     ...
     Discount{' '}
          ...
          <p className='mt-2 text-sm text-muted-foreground'>
              Discover Our Exclusive Products at Special Prices
            </p>   
